...
function View-DailyWork{
    ...
    $Today.Score = $Today.Written + $Today.Chat*1 + $Today.Phone*1
    ...
    # Summary
    $TodayReview | Format-Table -Property Date, Score, Written, Chat, Phone
    Write-host "How Score counts:  Score = Written*1 + Chat*1 + Phone*1"
...
function View-MonthlyWork{
    ...
    # sum, calculate the grade
    $Month.Score = $Month.Written + $Month.Chat*1 + $Month.Phone*1
    ...
    # Summary
    $MonthReview | Format-Table -Property Date, Score, Written, Chat, Phone
    Write-host "How Score counts:  Score = Written*1 + Chat*1 + Phone*1"
